...
namespace Spice.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var menuItemFormDb = await _db.MenuItem.Include(m => m.Category).Include(m => m.SubCategory).Where(m => m.Id == id).FirstOrDefaultAsync();

            ShoppingCart cartObj = new ShoppingCart()
            {
                MenuItem = menuItemFormDb,
                MenuItemId = menuItemFormDb.Id
            };
