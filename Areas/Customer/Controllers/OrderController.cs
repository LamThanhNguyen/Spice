    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> ManageOrder(int productPage = 1)
        {
            ...
            List<OrderHeader> OrderHeaderList = await _db.OrderHeader
                                                            .Where(o => o.Status == SD.StatusSubmitted || o.Status == SD.StatusInProgess)
        ...
        public async Task<IActionResult> OrderPrepare(int OrderId)
        {
            ...
            orderHeader.Status = SD.StatusInProgess;
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Completed" + orderHeader.Id.ToString(), "Order has been completed succesfully.");
